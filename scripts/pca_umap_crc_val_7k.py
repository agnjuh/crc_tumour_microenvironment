...
OUT_PCA = Path("results/figures/crc_val_7k_pca_morphology.png")
OUT_UMAP = Path("results/figures/crc_val_7k_umap_morphology.png")
OUT_COORDS = Path("results/tables/crc_val_7k_pca_umap_coordinates.tsv")
